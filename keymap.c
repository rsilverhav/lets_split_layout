 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | CtrlTab rtSc|  Alt | GUI  |Lower | Bksp | Space|Raise | VolDn| VolUp| Pl/Ps| Next |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12 ( \
  ...
  KC_LCTRL, RAISE, KC_LALT, KC_LGUI, LOWER,   KC_BSPC,  KC_SPC,  RAISE,   KC_VOLD, KC_VOLU, KC_MPLY, ADJUST  \
),
...
[_NUMPAD] = LAYOUT_ortho_4x12( \
  KC_ESC,  KC_KP_7, KC_KP_8, KC_KP_9, KC_KP_MINUS,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_BSPC, \
  KC_LCTL, KC_KP_4, KC_KP_5, KC_KP_6, KC_KP_PLUS,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT, \
  KC_LSFT, KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_SLASH,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT , \
  ADJUST,  KC_PSCR, KC_KP_2, KC_LALT, KC_KP_ASTERISK,   KC_TAB,  KC_SPC,  RAISE,   KC_VOLD, KC_VOLU, KC_MPLY, KC_MNXT  \
),
...
[_ADJUST] =  LAYOUT_ortho_4x12( \
  _______, KC_MPRV, KC_MPLY, KC_MNXT,  QWERTY,  NUMPAD, _______,  _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, \
